...
export default function EarthOutro() {
  return (
    ...
    >
      ...
      />
      {/* Overlay */}
      <div style={{ position: 'absolute', inset: 0, background: 'var(--surface-canvas)', opacity: 0.6, zIndex: 2 }} />

      <div className="container" style={{ position: 'relative', zIndex: 3 }}>
        <div style={{
          display: 'flex', flexDirection: 'column', alignItems: 'center',
          textAlign: 'center', gap: 24, maxWidth: 600, margin: '0 auto',
        }}>
          <div className="announcement-banner reveal">
            <span style={{ width: 5, height: 5, borderRadius: '50%', background: 'var(--color-highlighter-lime)', animation: 'pulse 2s infinite', display: 'inline-block' }} />
            Begin your story
          </div>
