  ...
  return (
    <section style={{ background: 'var(--surface-canvas)', padding: '80px 0' }}>
      <div className="container">
        <div className="card-dark reveal" style={{ background: 'var(--surface-card-white)', border: '1px solid rgba(220,38,38,0.18)', borderRadius: '36px', overflow: 'hidden', position: 'relative' }}>
          {/* Decorative gradient blobs */}
          <div style={{ position: 'absolute', top: -80, right: -80, width: 280, height: 280, borderRadius: '50%', background: 'radial-gradient(circle, rgba(255,255,255,0.02) 0%, transparent 70%)', pointerEvents: 'none' }} />
          <div style={{ position: 'absolute', bottom: -60, left: 200, width: 220, height: 220, borderRadius: '50%', background: 'radial-gradient(circle, rgba(255,255,255,0.01) 0%, transparent 70%)', pointerEvents: 'none' }} />

          <div className="dark-panel-grid" style={{ padding: '48px', position: 'relative', zIndex: 1 }}>
            {/* Col 1: Intro */}
            <div>
              ...
              <h2 style={{ fontFamily: 'var(--font-cosmica)', fontWeight: 700, fontSize: 'clamp(26px, 3vw, 40px)', color: '#fff', lineHeight: 1.15, marginBottom: 18 }}>
                ...
                <span style={{ color: '#a1a1aa' }}>an assembly line.</span>
              </h2>
              <p style={{ fontFamily: 'var(--font-cosmica)', fontWeight: 400, fontSize: 15, color: '#a1a1aa', lineHeight: 1.7, marginBottom: 28 }}>
              ...
              <button
                ...
                style={{ border: 'none', transition: 'all 0.25s var(--ease-out)' }}
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
              {PAIN_POINTS.map((p, i) => (
                <div
                  ...
                  onMouseEnter={e => { (e.currentTarget as HTMLElement).style.paddingLeft = '8px'; (e.currentTarget as HTMLElement).style.background = 'rgba(255,255,255,0.04)'; }}
                ...
                >
                  ...
                  <p style={{ fontFamily: 'var(--font-cosmica)', fontSize: 13.5, lineHeight: 1.5 }}>
                    <span className="weight-lead" style={{ color: '#a1a1aa', fontWeight: 400 }}>{p.lead} </span>
                    <span className="weight-key" style={{ color: '#ffffff', fontWeight: 600 }}>{p.key}</span>
                  </p>
                </div>
              ))}
            </div>
            ...
            {/* Col 3: Image */}
            <div className="img-zoom-wrap" style={{ height: 360, borderRadius: '28px', overflow: 'hidden', position: 'relative' }}>
              ...
              <div style={{ position: 'absolute', bottom: 16, left: 16, right: 16 }}>
                <p style={{ fontFamily: 'var(--font-cosmica)', fontSize: 11, fontWeight: 600, color: 'var(--color-ash)', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: 4 }}>Raw Ecotourism</p>
