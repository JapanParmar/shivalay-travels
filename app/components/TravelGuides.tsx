      ...
      <div className="container">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 12 }}>
          {filtered.map((g, i) => (
            ...
            >
              {/* Image header */}
              <div className="img-zoom-wrap" style={{ height: 120, position: 'relative', overflow: 'hidden' }}>
                ...
                {g.badge && (
                  <span className="badge" style={{ position: 'absolute', top: 10, right: 12, background: g.badgeColor, color: '#fff', fontSize: 10 }}>{g.badge}</span>
                )}
              </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12, padding: '18px 20px', flex: 1 }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <span style={{ fontFamily: 'var(--font-cosmica)', fontSize: 12, color: 'var(--color-ash)' }}>{g.readTime}</span>
                  <div style={{
